...
import com.video.compres.video.MediaController;
...
public class VideoCompressor {
    ...
    private static class VideoCompressorTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... path) {
            return MediaController.getInstance().convertVideo(path[0], path[1], new MediaController.OnProgressUpdateListener() {
                @Override
